...
@"Server=localhost\sqlexpress;Database=Productos2;TrustServerCertificate=true;Integrated Security=SSPI;";
        ...
        // Manejador del evento Load
        private void frmProductos_Load(object sender, EventArgs e)
        {
            // Configurar el estado de los controles al cargar el formulario
